...
namespace TAIE
{
    ...
    public partial class Home : Form
    {
        ...
        private void All_Clear_Data()
        {
            ...
            lb_Emp_No.Text = "";
            lb_Name.Text = "";
            Dgv_Show_Preview.DataSource = null;
        }
        ...
        private void Export_Excell()
        {
            try
            {
                ...
                {
                    MessageBox.Show("Check row in Config tab.", "Alert!");
                }
                ...
                workBook.Close();
                excelApp.Quit();
                MessageBox.Show(" \n File Location : " + tb_Dest_file.Text + "\\" + tb_Groupbox_Data_Project.Text + "_" + lb_Name.Text + "_" + fileDatetime.ToString("MMMyyyy") + ".xls", "Export Complete!");
            }
            catch (Exception)
            {
                MessageBox.Show("Please check Project Detail.", "Export Alert!");
            }
        }
